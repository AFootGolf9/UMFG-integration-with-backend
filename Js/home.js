function load() {
    ...
    if (cookies.token) {
        ...
        let dataExpiracao = parseDate(cookies.dataExpiracao);
        let email = cookies.email;

        document.getElementById("welcomeMessage").innerHTML = `Seja bem-vindo(a), ${email}! Seu token expira em ${dataExpiracao}`;
    } else {
